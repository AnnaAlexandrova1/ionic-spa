...
export default function ItemPage({ beerItem }: ItemPageProps) {
    return (
           ...
           <IonCardHeader className="item-page-header">
            ...
            <IonCardSubtitle>
          Крепость: {beerItem.abv}%
            </IonCardSubtitle>

          </IonCardHeader>
          <IonCardContent>
                <img className='card-image item-page-image' alt={beerItem.name} src={beerItem.image_url} />
                ...
                <div className="card-content-container">
                    ...
                    <div className="card-content-item">
                        Food Paring: 
                        {beerItem.food_pairing.map((item, i) => { return (<p key={i}>{item}</p>) })}
                    </div>
                </div>
            </IonCardContent>
